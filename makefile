...
#Created by Dionísio Carvalho & Luís loja Rique
...
loja.so: $(SRC_DIR)/loja.cpp $(INC_DIR)/bancodados.h $(INC_DIR)/fornecedor.h $(INC_DIR)/funcoes.h $(INC_DIR)/lista.h $(INC_DIR)/venda.h $(INC_DIR)/menu.h $(INC_DIR)/perecivel.h $(INC_DIR)/produto.h $(INC_DIR)/subproduto.h $(INC_DIR)/loja.h
	$(CC) $(CFLAGS) -fPIC -c $(SRC_DIR)/loja.cpp -o $(OBJ_DIR)/loja.o
	$(CC) -shared -fPIC -o $(LIB_DIR)/$@ $(OBJ_DIR)/loja.o
